...
export default function Content() {
  ...
  const handlePageChange = (e) => setPaging(Number(e.target.value));
      ...
      <div className="mt-[40px]">
        <div className="flex justify-between">
          ...
          <div className="flex gap-[12px]">
            ...
            />
            <button className="bg-[#3692FF] px-[23px] py-[12px] rounded-lg text-white">
              상품 등록하기
            </button>
            <select
        ...
        <div className="mt-[43px] flex justify-center gap-[4px]">
          <button
            ...
            className="w-[40px] h-[40px] rounded-full border font-bold"
          >
            &lt;
          </button>
